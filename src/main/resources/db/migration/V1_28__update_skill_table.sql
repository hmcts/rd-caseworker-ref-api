...
INSERT INTO SKILL(skill_id,skill_code,description,service_id,user_type,created_date,last_update) VALUES
	 (44,'SKILL:AAA7:DAMAGES_MULTI_TRACK_TRIAL_MANAGEMENT','Multi Track Trial Management','AAA7','Future Operations',timezone('utc', now()),timezone('utc', now()));
INSERT INTO SKILL(skill_id,skill_code,description,service_id,user_type,created_date,last_update) VALUES
	 (45,'SKILL:AAA6:SPECIFIED_MULTI_TRACK_TRIAL_MANAGEMENT','Multi Track Trial Management','AAA6','Future Operations',timezone('utc', now()),timezone('utc', now()));
