...
public class CaseWorkerUploadForUpdateUserWithFileUploadTestTest extends FileUploadTest {
    ...
    public void shouldCreateCaseWorkerUpdateAuditSuccess() throws Exception {
        ...
        modifyUserRoles();
        response = uploadCaseWorkerFile("CaseWorkerUserUpdateXlsxWithNoPassword.xlsx",
