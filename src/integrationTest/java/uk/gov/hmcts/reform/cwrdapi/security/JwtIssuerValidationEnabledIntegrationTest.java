...
import static uk.gov.hmcts.reform.cwrdapi.security.BaseSecurityIntegrationTest.VALID_ISSUER_1;
import static uk.gov.hmcts.reform.cwrdapi.security.BaseSecurityIntegrationTest.VALID_ISSUER_2;
...
public class JwtIssuerValidationEnabledIntegrationTest extends BaseSecurityIntegrationTest {
    ...
    void issuerValidationEnabled_shouldReturnExpectedStatus(String scenario,
        ...
        jwtRequestSpecification
                ...
                .request()
                .with()
                .body(getStaffProfileCreationRequest())
                .and()
                .post(CREATE_STAFF_URI)
                .then()
                .assertThat()
