DELETE FROM CASE_WORKER_SKILL WHERE SKILL_ID IN (
SELECT skill_id FROM SKILL WHERE skill_code IN ('SKILL:ABA5:TEST1','SKILL:ABA5:TEST2','SKILL:ABA5:TEST3','SKILL:ABA5:TEST4',
